...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_floating_point_range" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ea53701d#;
   pragma Export (C, u00001, "floating_point_rangeB");
