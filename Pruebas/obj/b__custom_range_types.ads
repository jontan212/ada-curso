...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_custom_range_types" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6eb1bf95#;
   pragma Export (C, u00001, "custom_range_typesB");
