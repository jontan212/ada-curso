...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_floating_point_range_exception" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d47d735e#;
   pragma Export (C, u00001, "floating_point_range_exceptionB");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  floating_point_range_exception%b
