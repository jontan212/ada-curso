...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mutually_recursive_subprograms" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#931dc6e7#;
   pragma Export (C, u00001, "mutually_recursive_subprogramsB");
   ...
   --  ada.exceptions%b
   --  mutually_recursive_subprograms%b
