...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_display_custom_floating_types" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1e37b533#;
   pragma Export (C, u00001, "display_custom_floating_typesB");
   ...
   u00123 : constant Version_32 := 16#6424aad3#;
   pragma Export (C, u00123, "system__img_fltS");
   u00124 : constant Version_32 := 16#ecc88e78#;
   ...
   u00126 : constant Version_32 := 16#cf061228#;
   ...
   u00129 : constant Version_32 := 16#690df0ad#;
   pragma Export (C, u00129, "system__powten_fltS");
   u00130 : constant Version_32 := 16#1422974c#;
   pragma Export (C, u00130, "system__img_llfS");
   u00131 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00131, "system__fat_llfS");
   u00132 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00132, "system__img_lluS");
   u00133 : constant Version_32 := 16#b6fa998a#;
   pragma Export (C, u00133, "system__powten_llfS");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  display_custom_floating_types%b
