...
package Juego is
  ...
  Default_Max_Hp    : constant Integer := 1_000;
  Default_Max_Level : constant Integer := 20;

  type Profesiones is (Guerrero, Mago, Assesino, Ninja, Sanador) with
   Default_Value => Guerrero;

  type Niveles is range 1 .. Default_Max_Level with
   Default_Value => 1;

  type Vida is range 0 .. Default_Max_Hp with
   Default_Value => 100;
